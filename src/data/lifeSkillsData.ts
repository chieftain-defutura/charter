...
export const LifeSkillsData = [
  {
    image: ImageOne,
    title: "Aptitude trainings",
    description:
      "Daily, from Monday to Friday, our life-skill sessions host rigorous written aptitude tests, sharpening young minds for greatness.",
  },
  {
    image: ImageTwo,
    title: "Group discussions",
    description:
      "The group discussion is conducted weekly Twice for 30 minutes. Topics are based on generic and technical aspects in alternative days.",
  },
  {
    image: ImageThree,
